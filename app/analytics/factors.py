...
from app.analytics.ttm import compute_ttm_deduct_pe, compute_growth_rate
...
def compute_volatility(pct_chg_series: list[float], window: int = 60) -> Optional[float]:
    """
    计算近 N 日波动率（年化）
...
def compute_all_factors(
    ...
    Returns:
        FactorResult（原始因子已填充，评分字段待 scoring.py 填充）
    """
